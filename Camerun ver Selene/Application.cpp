...
//コンストラクタ
//=============================================================================
CApplication::CApplication(void) :m_pCore(NULL), m_pGraphicCard(NULL), m_pFileMgr(NULL), 
...
bool CApplication::Initialize()
{
	...
	m_pCore->SetVirtualScreenEnable( true );
	
	m_pCore->SetVirtualScreenSize( 800, 600, 1280, 960 );
